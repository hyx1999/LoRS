...
default_devices=0,1
default_method=lors
default_model=/fs/fast/u2021000902/hyx/Llama-2-13b-hf-wanda2of4
default_output=/fs/fast/u2021000902/hyx/lors/results/Llama-2-13b-hf-wanda2of4
...
CUDA_VISIBLE_DEVICES=${devices} \
    accelerate launch --config_file config/deepspeed/2gpu_g8.yaml \
    peft_sft.py \
    --peft_method ${method} \
    --dataset_name alpaca \
